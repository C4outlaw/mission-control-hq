(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))d(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&d(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerPolicy&&(t.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?t.credentials="include":i.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function d(i){if(i.ep)return;i.ep=!0;const t=n(i);fetch(i.href,t)}})();const S=[{name:"Bucket Burger",img:"assets/dishes/lunch/bucket-burger.jpg"},{name:"Bucket Fish Sandwich",img:"assets/dishes/lunch/bucket-fish-sandwich.jpg"},{name:"Key West Chicken",img:"assets/dishes/lunch/key-west-chicken-sandwich.jpg"},{name:"Tuna Melt",img:"assets/dishes/lunch/tuna-melt-sandwich.jpg"},{name:"Ahi Tuna Wrap",img:"assets/dishes/lunch/ahi-tuna-wrap.jpg"},{name:"Loaded Chicken Panini",img:"assets/dishes/lunch/loaded-chicken-panini.jpg"},{name:"Shrimp & Bacon Panini",img:"assets/dishes/lunch/shrimp-and-bacon-panini.jpg"},{name:"Steak & Mozzarella Panini",img:"assets/dishes/lunch/steak-and-mozzarella-panini.jpg"},{name:"Fish Tacos",img:"assets/dishes/lunch/fish-tacos.jpg"},{name:"Shrimp Tacos",img:"assets/dishes/lunch/shrimp-tacos.jpg"},{name:"Pulled Pork Tacos",img:"assets/dishes/lunch/pulled-pork-and-slaw-tacos.jpg"},{name:"Caesar Salad",img:"assets/dishes/lunch/caesar-salad.jpg"},{name:"House Salad",img:"assets/dishes/lunch/bucket-house-salad.jpg"},{name:"Buffalo Shrimp",img:"assets/dishes/lunch/buffalo-shrimp.jpg"},{name:"Chicken Tenders",img:"assets/dishes/lunch/chicken-tenders.jpg"},{name:"Conch Fritters",img:"assets/dishes/lunch/conch-fritters.jpg"},{name:"Corn Nuggets",img:"assets/dishes/lunch/corn-nuggets.jpg"},{name:"Crab Cakes",img:"assets/dishes/lunch/crab-cakes.jpg"},{name:"Fried Calamari",img:"assets/dishes/lunch/fried-calamari.jpg"},{name:"Mozzarella Sticks",img:"assets/dishes/lunch/fried-mozzarella-sticks.jpg"},{name:"Fried Shrimp",img:"assets/dishes/lunch/fried-shrimp-plate.jpg"},{name:"Onion Rings",img:"assets/dishes/lunch/onion-rings.jpg"},{name:"Smoked Fish Dip",img:"assets/dishes/lunch/smoked-fish-dip.jpg"},{name:"Wings",img:"assets/dishes/lunch/wings.jpg"}],I=[["The Big Beach","the-big-beach-breakfast"],["The Early Bird","early-bird-breakfast"],["The Sunrise","the-sunrise-breakfast"],["Biscuits & Gravy","biscuits-and-gravy"],["Seafood Omelet","seafood-omelet"],["Chorizo Omelet","chorizo-omelet"],["Veggie Omelet","veggie-omelet"],["French Toast","french-toast-three-slices"],["Healthy Surfer","healthy-surfer-breakfast"],["Classic Benedict","classic-benedict"]],G=[["Blueberry Bay Breeze","blueberry-bay-breeze"],["Cherry Limeade","cherry-lemonade"],["Citrus Seabreeze","citrus-seabreeze"],["Cucumber Cooler","cucumber-cooler"],["Grape Pop","grape-pop"],["Orange Crush","orange-crush"],["Raspberry Lemonade","rapsberry-lemonade"]],N=[...I.map(([e,a])=>({category:"breakfast",label:e,img:`assets/dishes/breakfast/${a}.jpg`})),...S.map(e=>({category:"lunch",label:e.name,img:e.img})),...G.map(([e,a])=>({category:"drinks",label:e,img:`assets/drinks/${a}.png`})),{category:"atmosphere",label:"Oceanfront Patio at Sunset",img:"assets/venue/deck-sunrise.jpg"},{category:"atmosphere",label:"The Full Bar",img:"assets/venue/bar.jpg"},{category:"atmosphere",label:"Indoor Dining",img:"assets/venue/indoor-dining.jpg"},{category:"atmosphere",label:"Beachfront Exterior",img:"assets/venue/exterior.jpg"},{category:"atmosphere",label:"Sunset Deck Views",img:"assets/atmosphere/atmosphere-sunset-1.jpg"},{category:"atmosphere",label:"Evening on the Atlantic",img:"assets/atmosphere/atmosphere-sunset-2.jpg"}],C=[{title:"Breakfast Omelettes (Served 7AM to 11AM)",items:[["Seafood Omelet","$16.49","House specialty. A beach favorite stuffed with blue swimming crab and shrimp, then topped with creamy hollandaise sauce."],["Swiss Bacon Mushroom Omelet","$12.79","Crispy bacon, sauteed mushrooms, and melted Swiss cheese folded into a fluffy 3-egg omelet."],["Ormond Omelet","$13.29","Grilled ham, onions, and sweet peppers in a fluffy omelet. Add cheese for $1.99."],["Meat Lover's Omelet","$14.29","Loaded with sausage, bacon, and ham, finished with melted cheddar cheese."],["Cheese Omelet","$13.29","Extra cheesy omelet with a double portion of your choice of American, Swiss, provolone, or cheddar."],["Chorizo Omelet","$13.79","Spicy chorizo, peppers, onions, and provolone, topped with sweet chili sauce for the perfect sweet-heat bite."],["Veggie Omelet","$13.29","Tomatoes, onions, mushrooms, and peppers with cheddar cheese, fresh and full of flavor."]]},{title:"Benedicts",items:[["CHORIZO","$13.99","Toasted English muffin topped with spicy chorizo patties, poached eggs, and creamy hollandaise."],["CLASSIC","$13.99","Smoky Canadian bacon, poached eggs, and rich hollandaise on a toasted English muffin."],["BLUE SWIMMING CRAB (House Specialty)","$16.29","Coastal benedict topped with blue swimming crabmeat, poached eggs, and creamy hollandaise."]]},{title:"Breakfast Combos",items:[["#1 Early Bird","$10.99","Two eggs cooked your way with your choice of bacon (2), sausage links (2), or sausage patty (1)."],["#2 The Sunrise","$10.79","Two eggs with thick sliced smoked ham, hearty and classic."],["#3 Biscuits and Gravy","$11.29","Two eggs with a warm biscuit split and covered in rich sausage gravy. Does not include toast."],["#4 The Big Beach","$12.49","Two eggs, two slices of bacon, and two sausage links for a big breakfast."]]},{title:"Breakfast Favorites",items:[["Breakfast Sandwich","$11.29","Two eggs with your choice of toast (substitute biscuit or English muffin for $0.99), plus your choice of bacon (2), sausage patty, or chorizo patty. Served with home fries. Add cheese for $0.99."],["Healthy Surfer","$13.49","Scrambled egg whites with tomato slices, a fresh fruit cup, and a toasted English muffin."]]},{title:"French Toast",items:[["Three Slices French Toast","$11.99","Three thick slices grilled golden and dusted with powdered sugar."],["French Toast Breakfast Combo","$13.79","Three slices of French toast with your choice of 2 pieces of bacon or sausage links and one egg."]]},{title:"Breakfast Beverages",items:[["Coffee","","Fresh-brewed, hot, and smooth. The classic breakfast drink."],["Hot Tea","","A warm cup of tea, steeped fresh and served hot."],["Fresh Squeezed Orange Juice (Small/Large)","","Bright, fresh-squeezed Florida orange juice, served small or large."],["Iced Tea","","Cold, crisp iced tea served over ice."],["Sweet Tea","","Classic Southern sweet tea, cold and refreshing."],["Pepsi Products","","A full selection of Pepsi soft drinks served ice-cold."],["Mimosa's","","Chilled sparkling wine mixed with fruit juice, perfect for brunch."],["Bloody Mary's","","Our famous Bloody Mary, bold, savory, and brunch-ready."],["Full Bar","","Cocktails, beer, and wine available all day."]]},{title:"Breakfast Sides",items:[["Slice of French Toast","$3.99","One thick slice grilled golden and dusted with powdered sugar."],["Grits","$3.29","Creamy, buttery grits cooked smooth and served hot."],["Sausage Links (Four)","$4.29","Four juicy sausage links cooked until browned."],["Toast","$2.99","Warm toast served with butter and your choice of bread."],["Home Fries","$2.99","Crispy breakfast potatoes, golden outside and tender inside."],["Sausage Patty (Two)","$4.29","Two savory sausage patties, grilled and seasoned."],["English Muffin","$2.99","Toasted English muffin with a buttery, crisp edge."],["One Egg","$2.99","One fresh egg cooked your way."],["Chorizo Sausage Patty (Two)","$4.29","Two spicy chorizo patties with big flavor and a little kick."],["Biscuit","$2.99","Fluffy buttermilk biscuit served warm."],["Fresh Fruit Cup","$3.79","A light mix of fresh, chilled fruit."],["Bacon (Four)","$4.29","Four strips of crispy, smoky bacon."],["Sausage Gravy","$1.99","Rich, peppery sausage gravy, perfect for biscuits or dipping."],["Fresh Fruit Bowl","$5.79","A larger bowl of fresh fruit, cool and refreshing."],["Ham Slice","$5.29","Thick sliced ham, grilled and lightly smoky."]]},{title:"Lunch & Dinner Starters",items:[["Peel & Eat Shrimp (1/2 Pound / Full Pound)","$16.49 / $23.49","Shell-on shrimp steamed warm and seasoned with our secret coastal blend. Served with cocktail sauce and melted butter."],["Conch Fritters","$15.49","Tender conch mixed with island spices, fried golden and crisp. Served with creamy remoulade."],["Fried Calamari","$13.79","Lightly seasoned calamari, fried crispy and golden brown. Served with marinara or remoulade."],["Fried Mozzarella Sticks","$11.99","Golden-fried mozzarella sticks with a melty cheese pull in every bite. Served with marinara or ranch."],["Smoked Fish Dip","$14.29","House-smoked wahoo and mahi mahi blended with signature seasoning and creamy spread. Served with tortilla chips."],["Wings","$16.99","One pound of wings tossed in Bucket Sauce or Buffalo (mild/hot), teriyaki, garlic butter, or BBQ. Add fries for $3.99."],["Buffalo Shrimp","$15.49","Hand-breaded shrimp tossed in Buffalo sauce (mild or hot). Add fries for $3.99."],["Crab Cakes","$16.99","Lump crab cakes pan-seared until golden and flavorful. Served with remoulade."],["Onion Rings","$11.49","Thick-cut onion rings fried crispy and golden. Served with remoulade."],["Sweet Potato Fries","$8.99","Crispy sweet potato fries seasoned with a light touch of salt and pepper."],["Pork Nachos","$15.49","Pulled pork in Bucket Sauce over crispy tortilla chips with queso, tomatoes, onions, salsa, and sour cream."],["Corn Nuggets","$8.99","Sweet corn bites fried golden and dusted with powdered sugar. Served with ranch and maple syrup."],["Pretzels","$11.99","Soft Bavarian pretzels, warm and lightly salted. Served with queso cheese dip."]]},{title:"Lunch & Dinner Salads",items:[["Tomato Avocado Salsa Salad","$12.99","Fresh mixed greens with tomatoes, onions, cheddar, croutons, and house tomato avocado salsa."],["Caesar Salad (Small)","$6.99","Crisp romaine tossed with creamy Caesar dressing, parmesan, and crunchy croutons."],["Caesar Salad (Large)","$10.99","Crisp romaine tossed with creamy Caesar dressing, parmesan, and crunchy croutons."],["Bucket House Salad (Small)","$6.99","Fresh mixed greens with garden toppings and croutons, served with your choice of dressing."],["Bucket House Salad (Large)","$10.99","Fresh mixed greens with garden toppings and croutons, served with your choice of dressing."],["Add: Grilled Chicken Breast or Tuna Salad","$6.99","Add extra protein with grilled chicken breast or house-made tuna salad."],["Add: Grilled Mahi, Ahi Tuna Steak, or Grilled Shrimp","$7.99","Add fresh grilled seafood for a hearty beach-style meal."]]},{title:"Lunch & Dinner Entrees",items:[["Key West Chicken Sandwich","$13.49","Juicy grilled chicken seasoned with house Key West spice blend, served on a toasted bun with lettuce and tomato."],["Tuna Melt Sandwich (House Specialty)","$13.29","House tuna salad topped with melted cheddar on parmesan-encrusted sourdough."],["Shrimp and Bacon Panini","$16.29","Crispy fried shrimp in Bucket Sauce, pressed hot with bacon and cheddar."],["Steak and Mozzarella Panini","$15.49","Tender shaved steak with grilled tomatoes, fresh basil, and mozzarella, finished with balsamic reduction."],["Mozzarella Caprese Panini","$13.99","Melted mozzarella, grilled tomatoes, and fresh basil with balsamic reduction."],["Loaded Chicken Panini","$15.29","Grilled chicken with sauteed peppers, mushrooms, onions, and cheddar; served with tzatziki."],["Shrimp Tacos (House Specialty)","$15.79","Two flour tortillas with grilled/blackened/fried shrimp, spring mix, tomato avocado salsa, and cilantro aioli."],["Fish Tacos (House Specialty)","$15.29","Two flour tortillas with grilled/blackened/fried white fish, spring mix, tomato avocado salsa, and cilantro aioli."],["Pulled Pork and Slaw Tacos","$13.99","Two flour tortillas with pulled pork in Bucket Sauce, topped with creamy coleslaw."],["BBQ Burger","$15.99","Half-pound burger topped with BBQ pulled pork, crispy bacon, and BBQ sauce on a toasted bun."],["Bucket Burger","$14.99","Half-pound burger on a toasted bun with lettuce, tomato, raw onion, and pickles."],["Fish & Chips","$13.99","Mild white fish fried golden and crispy, served with tartar sauce and malt vinegar."],["Chicken Tender","$13.79","Golden fried chicken tenders seasoned with our special spice blend."],["Fried Shrimp","$15.99","Large sweet shrimp hand-breaded in house batter, fried golden and tender."],["Ahi Tuna Wrap","$16.49","Seasoned ahi tuna grilled medium-rare in a jalapeno cheese tortilla with spring mix and tomato avocado salsa."],["Bucket Fish Sandwich","$14.99","Mild white fish grilled, blackened, or fried on a toasted bun with lettuce, tomato, and tartar sauce."],["Fish & Shrimp Combo (House Specialty)","$25.99","Your choice of fried, blackened, or grilled fish and shrimp, with tartar, cocktail sauce, lemon wedge, and coleslaw."]]},{title:"Desserts",items:[["Chocolate Peanut Butter Pie","$8.49","Creamy chocolate and peanut butter in a rich, chilled pie slice."],["Key Lime Pie","$8.49","Tangy key lime filling with a sweet, crunchy crust."],["Salted Caramel Cheesecake","$8.49","Smooth cheesecake topped with salted caramel."]]}],r="assets/dishes/breakfast/",s="assets/dishes/lunch/",R={"Seafood Omelet":r+"seafood-omelet.jpg","Chorizo Omelet":r+"chorizo-omelet.jpg","Veggie Omelet":r+"veggie-omelet.jpg","Ormond Omelet":r+"veggie-omelet.jpg",CLASSIC:r+"classic-benedict.jpg","BLUE SWIMMING CRAB (House Specialty)":r+"seafood-omelet.jpg","#1 Early Bird":r+"early-bird-breakfast.jpg","#2 The Sunrise":r+"the-sunrise-breakfast.jpg","#3 Biscuits and Gravy":r+"biscuits-and-gravy.jpg","#4 The Big Beach":r+"the-big-beach-breakfast.jpg","Healthy Surfer":r+"healthy-surfer-breakfast.jpg","Three Slices French Toast":r+"french-toast-three-slices.jpg","French Toast Breakfast Combo":r+"french-toast-three-slices.jpg","Conch Fritters":s+"conch-fritters.jpg","Fried Calamari":s+"fried-calamari.jpg","Fried Mozzarella Sticks":s+"fried-mozzarella-sticks.jpg","Smoked Fish Dip":s+"smoked-fish-dip.jpg",Wings:s+"wings.jpg","Buffalo Shrimp":s+"buffalo-shrimp.jpg","Crab Cakes":s+"crab-cakes.jpg","Onion Rings":s+"onion-rings.jpg","Corn Nuggets":s+"corn-nuggets.jpg","Caesar Salad (Small)":s+"caesar-salad.jpg","Caesar Salad (Large)":s+"caesar-salad.jpg","Bucket House Salad (Small)":s+"bucket-house-salad.jpg","Bucket House Salad (Large)":s+"bucket-house-salad.jpg","Key West Chicken Sandwich":s+"key-west-chicken-sandwich.jpg","Tuna Melt Sandwich (House Specialty)":s+"tuna-melt-sandwich.jpg","Shrimp and Bacon Panini":s+"shrimp-and-bacon-panini.jpg","Steak and Mozzarella Panini":s+"steak-and-mozzarella-panini.jpg","Loaded Chicken Panini":s+"loaded-chicken-panini.jpg","Shrimp Tacos (House Specialty)":s+"shrimp-tacos.jpg","Fish Tacos (House Specialty)":s+"fish-tacos.jpg","Pulled Pork and Slaw Tacos":s+"pulled-pork-and-slaw-tacos.jpg","Bucket Burger":s+"bucket-burger.jpg","Chicken Tender":s+"chicken-tenders.jpg","Fried Shrimp":s+"fried-shrimp-plate.jpg","Ahi Tuna Wrap":s+"ahi-tuna-wrap.jpg","Bucket Fish Sandwich":s+"bucket-fish-sandwich.jpg"},W=[{name:"Steak & Mozzarella Panini",img:s+"steak-and-mozzarella-panini.jpg",blurb:"Shaved steak, fresh mozzarella, grilled tomato & basil, balsamic reduction.",price:"15.49"},{name:"Shrimp Tacos",img:s+"shrimp-tacos.jpg",blurb:"Blackened shrimp, avocado, tomato salsa & cilantro aioli in soft tortillas.",price:"15.79"},{name:"Crab Cakes",img:s+"crab-cakes.jpg",blurb:"Lump crab cakes pan-seared golden, served with house remoulade.",price:"16.99"},{name:"Fried Shrimp",img:s+"fried-shrimp-plate.jpg",blurb:"Large sweet shrimp hand-breaded in our house batter, fried golden and tender.",price:"15.99"},{name:"Tuna Melt",img:s+"tuna-melt-sandwich.jpg",blurb:"House tuna salad & melted cheddar on parmesan-crusted sourdough.",price:"13.29"},{name:"Bucket Burger",img:s+"bucket-burger.jpg",blurb:"Half-pound char-grilled burger, lettuce, tomato, onion & pickles on a toasted bun.",price:"14.99"},{name:"Fish Tacos",img:s+"fish-tacos.jpg",blurb:"Grilled, blackened or fried white fish with pico, cilantro-lime crema & avocado.",price:"15.29"},{name:"Wings",img:s+"wings.jpg",blurb:"A pound of jumbo wings tossed in Bucket Sauce, Buffalo, teriyaki, garlic butter or BBQ.",price:"16.99"},{name:"Ahi Tuna Wrap",img:s+"ahi-tuna-wrap.jpg",blurb:"Seared ahi tuna in a jalapeno cheese tortilla with spring mix and tomato avocado salsa.",price:"16.49"}],V=[{name:"Seafood Omelet",img:r+"seafood-omelet.jpg",blurb:"Blue swimming crab & shrimp folded into a fluffy omelet, finished with creamy hollandaise.",price:"16.49"},{name:"Blue Swimming Crab Benedict",img:r+"blue-swimming-crab-benedict.jpg",blurb:"House specialty: blue crabmeat, poached eggs & creamy hollandaise on a toasted muffin.",price:"16.29"},{name:"Classic Eggs Benedict",img:r+"classic-benedict.jpg",blurb:"Smoky Canadian bacon, poached eggs & rich hollandaise on a toasted English muffin.",price:"13.99"},{name:"The Big Beach",img:r+"the-big-beach-breakfast.jpg",blurb:"Two eggs, two bacon strips and two sausage links for a hearty big breakfast.",price:"12.49"},{name:"Healthy Surfer",img:r+"healthy-surfer-breakfast.jpg",blurb:"Scrambled egg whites with tomato slices, fresh fruit cup and a toasted English muffin.",price:"13.49"},{name:"French Toast",img:r+"french-toast-three-slices.jpg",blurb:"Three thick slices grilled golden and dusted with powdered sugar, with warm syrup.",price:"11.99"},{name:"Chorizo Omelet",img:r+"chorizo-omelet.jpg",blurb:"Spicy chorizo, peppers, onions & provolone, topped with sweet chili for the perfect kick.",price:"13.79"},{name:"Biscuits & Gravy",img:r+"biscuits-and-gravy.jpg",blurb:"Two eggs with a warm split biscuit covered in rich, peppery sausage gravy.",price:"11.29"},{name:"The Sunrise",img:r+"the-sunrise-breakfast.jpg",blurb:"Two eggs with a thick-sliced smoked ham steak and seasoned home fries.",price:"10.79"}],A=C.flatMap(e=>e.items.map(a=>a[0])),T=C.flatMap(e=>e.items.map(a=>a[2]));let U=0;const _=C.map(e=>{const a=e.items.map(t=>{const o=U++,l=/\(House Specialty\)/i.test(t[0]),c=t[0].replace(/\s*\(House Specialty\)/i,""),p=(t[1]||"").replace(/\$/g,""),k=p?`<span class="m-price">${p}</span>`:"",x=l?'<span class="m-badge">Signature Dishes</span>':"",f=R[t[0]],H=f?`<button class="m-thumb item-thumb-btn" data-img="${f}" data-name="${c}" aria-label="View photo of ${c}"><img src="${f}" alt="${c}" loading="lazy" /></button>`:"";return`
  ...
  </article>`;W.map(P).join("");const Q=V.map(P).join("");document.querySelector("#app").innerHTML=`
  ...
  <main id="main-content" tabindex="-1">
    ...
    <section id="menu" class="section" aria-labelledby="menu-heading">
      <div class="container">
        ...
        <div class="menu-feature" id="sigBreakfast">${Q}</div>
        <div class="menu-divider" aria-hidden="true"></div>
        <h3 class="menu-full-title">The Full Menu</h3>
        <div class="menu-wrap">${_}</div>
