        ...
        <div class="item-body">
          <div class="item-head">
            <button class="item-name-btn" data-img="${l}" data-name="${t[0]}" aria-label="View photo of ${t[0]}">
              <span class="item-name" data-menu-name="${i}">${t[0]}</span>
            </button>
            <span class="item-price">${t[1]}</span>
          </div>
          <p data-menu-desc="${i}">${t[2]}</p>
        </div>
      </li>`}).join("");return`
  ...
  <main id="main-content" tabindex="-1">
      ...
      <div class="container">
        ...
        <div class="dish-stack-stage" id="dishStackStage" role="region" aria-roledescription="carousel" aria-label="Beach Bucket lunch dishes">
          ...
          <div class="dish-stack" id="dishStack">
            ${C.map((a,s)=>`
              <figure class="ds-card" data-i="${s}" role="group" aria-roledescription="slide" aria-label="${s+1} of ${C.length}: ${a.name}">
    ...
    <section id="gallery" class="section alt" aria-labelledby="gallery-heading">
      <div class="container">
        ...
        <div class="drink-stack-divider"></div>
        <h3 class="drink-stack-heading">Drink Specials</h3>
        <p class="muted">Flip through our weekday combos &amp; signature drinks &mdash; full cards, no cropping.</p>
        <div class="dish-stack-stage" id="drinkStackStage" role="region" aria-roledescription="carousel" aria-label="Beach Bucket drink specials">
          ...
          <div class="dish-stack" id="drinkStack">
            ${A.map((a,s)=>`
              <figure class="ds-card" data-i="${s}" role="group" aria-roledescription="slide" aria-label="${s+1} of ${A.length}: ${a.name}">
                <img src="${e(a.img)}" alt="${a.name}" loading="lazy" draggable="false" />
              </figure>
            `).join("")}
          </div>
