  ...
  <main id="main-content" tabindex="-1">
    ...
    <section id="our-dishes" class="section dish-carousel-section" aria-labelledby="our-dishes-heading">
      <div class="container">
        ...
        <p class="muted">Slide through our full lunch lineup &mdash; House Specialties, sandwiches, paninis, tacos, salads &amp; sides.</p>
        <div class="dish-carousel-wrap">
          ...
          <div class="dish-carousel-track" id="dishCarouselTrack" role="region" aria-roledescription="carousel" aria-label="Beach Bucket dishes">
            ${v.map((a,t)=>`
              <figure class="dish-slide" role="group" aria-roledescription="slide" aria-label="${t+1} of ${v.length}: ${a.name}">
                <div class="dish-slide-img"><img src="${e(a.img)}" alt="${a.name}" loading="lazy" /></div>
