...
export const PREMIUM_PRODUCTS = [
  { key: 'premium-wahgwaan-black', design: 'wahgwaan', kind: 'tee', name: 'Wah Gwaan — Premium Black Tee', blurb: 'Luxury fashion-house typography. The greeting, elevated.', price: 3999, compareAt: 5499, image: '/store/premium/wah-gwaan-premium-black.webp' },
  { key: 'premium-wahgwaan-white', design: 'wahgwaan', kind: 'tee', name: 'Wah Gwaan — Premium White Tee', blurb: 'Black luxury type on white. Clean and premium.', price: 3999, compareAt: 5499, image: '/store/premium/wah-gwaan-premium-white.webp' },
  { key: 'premium-876-black', design: 'area876', kind: 'tee', name: '876 — Premium Black Tee', blurb: 'Polished numerals, luxury athletic energy.', price: 3999, compareAt: 5499, image: '/store/premium/876-premium-black.webp' },
  { key: 'premium-876-white', design: 'area876', kind: 'tee', name: '876 — Premium White Tee', blurb: 'Black luxury numerals on white.', price: 3999, compareAt: 5499, image: '/store/premium/876-premium-white.webp' },
  { key: 'premium-tallawah-black', design: 'tallawah', kind: 'tee', name: 'Likkle But Tallawah — Premium Black Tee', blurb: 'Small but mighty, in fashion-house type.', price: 3999, compareAt: 5499, image: '/store/premium/likkle-but-tallawah-premium-black.webp' },
  { key: 'premium-tallawah-white', design: 'tallawah', kind: 'tee', name: 'Likkle But Tallawah — Premium White Tee', blurb: 'Black luxury type on white.', price: 3999, compareAt: 5499, image: '/store/premium/likkle-but-tallawah-premium-white.webp' },
  { key: 'premium-notperfect-black', design: 'notperfect', kind: 'tee', name: 'Not Perfect But Jamaican — Premium Black Tee', blurb: 'And that\'s close enough. Luxury typography.', price: 3999, compareAt: 5499, image: '/store/premium/not-perfect-but-jamaican-premium-black.webp' },
  { key: 'premium-xmark-black', design: 'xmark', kind: 'tee', name: 'The Lost Jamaican X — Premium Black Tee', blurb: 'The emblem, reimagined in luxury.', price: 3999, compareAt: 5499, image: '/store/premium/lost-jamaican-x-premium-black.webp' },
  { key: 'premium-xmark-white', design: 'xmark', kind: 'tee', name: 'The Lost Jamaican X — Premium White Tee', blurb: 'Black luxury emblem on white.', price: 3999, compareAt: 5499, image: '/store/premium/lost-jamaican-x-premium-white.webp' },
  { key: 'premium-cho-black', design: 'cho', kind: 'tee', name: 'Cho! — Premium Black Tee', blurb: '/expression of annoyance/ — luxury edition.', price: 3999, compareAt: 5499, image: '/store/premium/cho-premium-black.webp' },
  { key: 'premium-rhaatid-black', design: 'rhaatid', kind: 'tee', name: 'Rhaatid! — Premium Black Tee', blurb: '/mild astonishment/ — luxury edition.', price: 3999, compareAt: 5499, image: '/store/premium/rhaatid-premium-black.webp' },
  { key: 'premium-sooncome-black', design: 'sooncome', kind: 'tee', name: 'Soon Come — Premium Black Tee', blurb: '/arriving eventually/ — in fashion-house type.', price: 3999, compareAt: 5499, image: '/store/premium/soon-come-premium-black.webp' },
  { key: 'premium-dunkno-black', design: 'dunkno', kind: 'tee', name: 'Dun Kno — Premium Black Tee', blurb: '/you already know/ — luxury edition.', price: 3999, compareAt: 5499, image: '/store/premium/dun-kno-premium-black.webp' },
  { key: 'premium-kissmiteeth-black', design: 'kissmiteeth', kind: 'tee', name: 'Kiss Mi Teeth — Premium Black Tee', blurb: '/the sound of disapproval/ — luxury edition.', price: 3999, compareAt: 5499, image: '/store/premium/kiss-mi-teeth-premium-black.webp' },
  { key: 'premium-walkgood-black', design: 'walkgood', kind: 'tee', name: 'Walk Good — Premium Black Tee', blurb: '/go safely, live well/ — in fashion-house type.', price: 3999, compareAt: 5499, image: '/store/premium/walk-good-premium-black.webp' },
  { key: 'premium-believe-black', design: 'believe', kind: 'tee', name: 'Believe Inna Yuhself — Premium Black Tee', blurb: 'Everyday motivation, luxury typography.', price: 3999, compareAt: 5499, image: '/store/premium/believe-inna-yuhself-premium-black.webp' },
  { key: 'premium-neverlose-white', design: 'neverlose', kind: 'tee', name: 'We Never Lose — Premium White Tee', blurb: 'The mantra. Black luxury type on white.', price: 3999, compareAt: 5499, image: '/store/premium/we-never-lose-premium-white.webp' },
  { key: 'premium-money-white', design: 'money', kind: 'hoodie', name: 'More Money Than Last Year — Premium White Hoodie', blurb: 'The mindset. Black luxury type on white.', price: 5999, compareAt: 7499, image: '/store/premium/more-money-premium-white.webp' },
  // The black premium look for the two brand lines, which existed only in white.
  { key: 'premium-neverlose-black', design: 'neverlose', kind: 'tee', name: 'We Never Lose — Premium Black Tee', blurb: 'The mantra, in the black premium look.', price: 3999, compareAt: 5499, image: '/store/premium/we-never-lose-premium-black.webp' },
  { key: 'premium-money-black', design: 'money', kind: 'tee', name: 'More Money Than Last Year — Premium Black Tee', blurb: 'The mindset, in the black premium look.', price: 3999, compareAt: 5499, image: '/store/premium/more-money-premium-black.webp' },
  { key: 'premium-neverlose-hoodie-black', design: 'neverlose', kind: 'hoodie', name: 'We Never Lose — Premium Black Hoodie', blurb: 'The mantra, heavyweight, in black.', price: 5999, compareAt: 7499, image: '/store/premium/we-never-lose-hoodie-premium-black.webp' },
  { key: 'premium-money-hoodie-black', design: 'money', kind: 'hoodie', name: 'More Money Than Last Year — Premium Black Hoodie', blurb: 'The mindset, heavyweight, in black.', price: 5999, compareAt: 7499, image: '/store/premium/more-money-hoodie-premium-black.webp' },
];
