...
const DESIGN = {
  ...
  moremoney: { label: 'More Money Than Last Year', blurb: 'The mantra in brush script under the flag, gold and green on black. Tee, tank, hoodie and cap — same lockup on every one.' },
