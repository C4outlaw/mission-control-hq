...
const TEE = { kind: 'tee', kindName: 'Unisex Tee', price: 2499 };
const HOODIE = { kind: 'hoodie', kindName: 'Pullover Hoodie', price: 4499 };
const CREW = { kind: 'crew', kindName: 'Crewneck Sweatshirt', price: 3999 };
const MUG = { kind: 'mug', kindName: 'Ceramic Mug 11oz', price: 1499 };
