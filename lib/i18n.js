...
export const TRANSLATIONS = {
  en: {
    ...
    'showcase.lede':     'Daily drinks promos, signature cocktail cards, social graphics. Production-ready, brand-consistent, printed on the bar tomorrow morning.',
    'showcase.cta':      'View the full design portfolio →',
    'showcase.no_signature': 'SIGNATURE',
    'showcase.drink_mon': 'Grape Pop · Yuengling',
    'showcase.drink_tue': 'Cucumber Cooler · Ultra Draft',
    'showcase.drink_wed': 'Signature pour',
    'showcase.drink_thu': 'Raspberry Lemonade · Coors',
    'showcase.drink_fri': 'Weekend pour',
    'showcase.drink_sat': 'Blueberry Bay Breeze · Landshark',
    'showcase.drink_sun': 'Brunch Bucket · Bottomless mimosas',
    'day.monday':     'Monday',
    'day.tuesday':    'Tuesday',
    ...
    'featured.brand_title':   'Hospitality Brand Designs',
    'featured.brand_tag':     'Brand · Photo · Menus',
    'featured.brand_copy':    'Daily drinks specials, signature cocktail cards, breakfast plate photography, and full menu rebuilds.',
    'featured.brand_label':   'View design portfolio',
    'featured.web_title':     'The Beach Bucket Website',
    'featured.web_tag':       'Web Design · Build',
    'featured.web_copy':      'A full oceanfront-restaurant website we designed and built end to end — menu, gallery, hours, and a mobile-first layout. Live and running in Ormond Beach.',
    'featured.web_label':     'See the website',
    'featured.app_title':     'Menu Magic: AI-generated outputs',
    'featured.app_tag':       'SaaS · Real outputs',
    'featured.app_copy':      'Cocktail cards, dish photography, recipe cards, social posts. Real outputs the app produces in seconds, printed on the bar that night.',
    'featured.app_label':     'Try the app',

    // Menu Magic App section
    'app.eyebrow':            'The application',
    'app.headline_a':         'Menu Magic.',
    'app.headline_b':         'A restaurant studio in one app.',
    'app.lede':               'Generate dishes, paired drinks, recipe cards, cookbooks, food-cost tables, and ready-to-post social content. Try it live below.',
    'app.cta_try':            'Try the app ↗',
    'app.outputs_eyebrow':    'What the app creates',
    'app.outputs_headline':   'Real outputs, generated in seconds.',
    'app.outputs_alt':        'cocktail card generated by Menu Magic',

    // Testimonials
    'testi.eyebrow':     'Client love',
    'testi.headline':    'What our clients say.',
    'testi.q1':          'Myrie HQ completely transformed our online presence. We saw a 40% increase in online orders.',
    'testi.q1_name':     'Restaurant Owner',
    'testi.q1_title':    'Daytona Beach, FL',
    'testi.q2':          "The local SEO work was a game-changer. We went from page 3 to the top of Google Maps. The phone hasn't stopped ringing.",
    'testi.q2_name':     'Local Business Owner',
    'testi.q2_title':    'Orlando, FL',
    'testi.q3':          'What sets Myrie apart is the automation. Our marketing runs itself now: social posts, email campaigns, review responses, all on autopilot.',
    'testi.q3_name':     'Franchise Operator',
    'testi.q3_title':    'Central Florida',

    // Mobile sticky CTA
    'mobile_cta.book':   'Book a call',
    ...
    'home_about.headline': "O'Neil Myrie.",
    ...
    'about.story_p1':      "O'Neil leads at the intersection of operations and marketing. The day-to-day of running a beachfront bar & grill: the rushes, the inventory, the staff, the daily specials, the tourists vs locals: that's the lens behind every project at Myrie HQ.",
    'about.story_p2':      "The mission is simple: help local businesses look world-class online and convert that visibility into real revenue. Through Myrie HQ, O'Neil supports restaurants, bars, and local brands across Daytona Beach and Orlando with modern web design, local SEO, brand creative, and the kind of marketing systems that actually ship every week.",
    ...
    'about.tl_2025_title': 'Menu Magic app',
    ...
    'bb.cta_live':            'View the live site',
    'bb.live_eyebrow':        'Live · Now Online',
    'bb.live_h':              'The full Beach Bucket website',
    'bb.live_lede':           'Beyond the brand design, we built and shipped the complete oceanfront restaurant website — cinematic video hero, editorial menu with photoreal dish photography, interactive gift cards, full English + Spanish translation, and one-tap directions.',

    // ────── Beach Bucket Website (case study) ──────
    'bbw.eyebrow':            'Live · Web Design & Build',
    'bbw.title_a':            'The Beach Bucket',
    'bbw.title_italic':       'website.',
    'bbw.sub':                "A premium hospitality website for an oceanfront restaurant in Ormond Beach, Florida — designed, built, and shipped in May 2026. Scroll, click, order, switch to Spanish — it's all live below.",
    'bbw.cta_open':           'Open the live site',
    'bbw.cta_build':          'Build mine like this',
    'bbw.iframe_title_laptop':'The Beach Bucket website on desktop',
    'bbw.iframe_title_phone': 'The Beach Bucket website on mobile',
    'bbw.mock_caption':       'Live preview — interact with the site directly inside the laptop or phone frame.',
    'bbw.what_eyebrow':       'What we shipped',
    'bbw.what_h':             'A full venue site — not a template.',
    'bbw.what_lead':          'Every section was custom-built from a hospitality design system: warm sand canvas, Manrope + Fraunces typography, gold price accents, editorial dotted leaders, no boxy SaaS cards. 80 dish photos were generated locally on Flux Schnell so every item on the menu shows the actual plate.',
    'bbw.tech_vite':          'Framework',
    'bbw.tech_video':         'Hero',
    'bbw.tech_video_v':       'Cinematic full-bleed video',
    'bbw.tech_menu':          'Menu',
    'bbw.tech_menu_v':        '80 photoreal AI-generated dish photos',
    'bbw.tech_i18n':          'Languages',
    'bbw.tech_perf':          'Performance',
    'bbw.tech_perf_v':        '40 MB total, sub-second first paint',
    'bbw.tech_deploy':        'Deployment',
    'bbw.feat_eyebrow':       'Six things to notice',
    'bbw.feat_h_a':           'Real polish',
    'bbw.feat_h_italic':      'in every detail',
    'bbw.feat1_h':            'Translucent aqua hero title',
    'bbw.feat1_p':            'The brand color sits on the video at 78% opacity so the ocean shows through the letterforms — a single design move that makes the hero feel cinematic rather than flat.',
    'bbw.feat2_h':            'Editorial 2-column menu',
    'bbw.feat2_p':            'Fraunces serif item names with classic dotted leaders, gold prices, italic descriptions, and a 72px photo thumbnail of every single dish. Click any name or thumb to open the full lightbox.',
    'bbw.feat3_h':            'Pulsing directions button',
    'bbw.feat3_p':            'No ugly map iframe. A black button with concentric gold rings pulsing outward — one tap opens Google Maps directions. Looks intentional, feels alive.',
    'bbw.feat4_h':            'Clickable gift card amounts',
    'bbw.feat4_p':            'A 2×2 card grid (Treat · Lunch · Date night · Celebration) where each pick updates the purchase CTA in real time. Editorial bottom-border form, no boxy SaaS inputs.',
    'bbw.feat5_h':            'Full English + Spanish',
    'bbw.feat5_p':            'Every visible string flows through a translation map and live-swaps on the language selector. Menu items auto-translate via API for languages we haven’t hand-localized yet.',
    'bbw.feat6_h':            'Mobile-first action bar',
    'bbw.feat6_p':            'Fixed bottom of every phone visit: one-tap Call, Directions, Order. The three actions a hungry visitor actually needs — and nothing else.',
    'bbw.final_h_a':          'Want a site like this for',
    'bbw.final_h_italic':     'your venue?',
    'bbw.final_lead':         'Restaurant, bar, café, lounge, gym, salon, hotel — the same design system scales. Tell me about your business and we’ll build it from scratch.',
    ...
    'proj.featured_pill':     'LIVE · WEBSITE',
    'proj.featured_tag':      'WEB DESIGN · BUILD · BILINGUAL',
    'proj.featured_title':    'The Beach Bucket Website',
    'proj.featured_blurb':    "A full premium hospitality website for an oceanfront restaurant in Ormond Beach, Florida. Cinematic video hero, editorial menu with 80 photoreal dish photos, interactive gift cards, full English + Spanish — designed, built, and shipped in May 2026.",
    'proj.metric1_num':       '80',
    'proj.metric1_label':     'AI-generated dish photos',
    'proj.metric2_num':       '14',
    'proj.metric2_label':     'Custom sections shipped',
    'proj.metric3_num':       '2',
    'proj.metric3_label':     'Languages live (EN + ES)',
    'proj.view_case':         'See it in action →',
    'proj.more_eyebrow':      'MORE WORK',
    'proj.more_h_a':          'Selected',
    'proj.more_h_italic':     'projects',
    'proj.view_project':      'View project →',
    'proj.r0_title':          'Beach Bucket Brand Design',
    'proj.r0_tag':            'BRAND DESIGN · PHOTOGRAPHY · MENUS',
    'proj.r0_blurb':          'The brand-design body of work for The Beach Bucket: daily-drink-special cards, signature cocktails, breakfast photography, and full menu rebuilds.',
    'proj.r1_title':          'Menu Magic App',
  ...
  es: {
    ...
    'showcase.lede':     'Promociones de bebidas diarias, tarjetas de cócteles de autor, gráficos sociales. Listos para producción, consistentes con la marca, impresos en el bar mañana por la mañana.',
    'showcase.cta':      'Ver el portafolio completo de diseño →',
    'showcase.no_signature': 'DE AUTOR',
    'showcase.drink_mon': 'Grape Pop · Yuengling',
    'showcase.drink_tue': 'Cucumber Cooler · Ultra Draft',
    'showcase.drink_wed': 'Bebida de la casa',
    'showcase.drink_thu': 'Raspberry Lemonade · Coors',
    'showcase.drink_fri': 'Bebida del fin de semana',
    'showcase.drink_sat': 'Blueberry Bay Breeze · Landshark',
    'showcase.drink_sun': 'Brunch Bucket · Mimosas ilimitadas',
    'day.monday':     'Lunes',
    'day.tuesday':    'Martes',
    ...
    'featured.brand_title':   'Diseños de Marca de Hospitalidad',
    'featured.brand_tag':     'Marca · Foto · Menús',
    'featured.brand_copy':    'Especiales diarios de bebidas, tarjetas de cócteles de autor, fotografía de platos del desayuno, y reconstrucciones completas de menús.',
    'featured.brand_label':   'Ver portafolio de diseño',
    'featured.web_title':     'El Sitio Web de The Beach Bucket',
    'featured.web_tag':       'Diseño Web · Desarrollo',
    'featured.web_copy':      'Un sitio web completo para un restaurante frente al mar, diseñado y construido de principio a fin — menú, galería, horarios y diseño mobile-first. En vivo en Ormond Beach.',
    'featured.web_label':     'Ver el sitio web',
    'featured.app_title':     'Menu Magic: resultados generados por IA',
    'featured.app_tag':       'SaaS · Resultados reales',
    'featured.app_copy':      'Tarjetas de cócteles, fotografía de platos, tarjetas de recetas, posts sociales. Resultados reales que la app produce en segundos, listos para imprimir en el bar esa misma noche.',
    'featured.app_label':     'Probar la app',

    // Menu Magic App section
    'app.eyebrow':            'La aplicación',
    'app.headline_a':         'Menu Magic.',
    'app.headline_b':         'Un estudio de restaurante en una sola app.',
    'app.lede':               'Genera platos, bebidas emparejadas, tarjetas de recetas, recetarios, tablas de costos de alimentos y contenido social listo para publicar. Pruébala en vivo abajo.',
    'app.cta_try':            'Probar la app ↗',
    'app.outputs_eyebrow':    'Lo que la app crea',
    'app.outputs_headline':   'Resultados reales, generados en segundos.',
    'app.outputs_alt':        'tarjeta de cóctel generada por Menu Magic',

    // Testimonials
    'testi.eyebrow':     'Reseñas de clientes',
    'testi.headline':    'Lo que dicen nuestros clientes.',
    'testi.q1':          'Myrie HQ transformó por completo nuestra presencia en línea. Vimos un aumento del 40% en los pedidos en línea.',
    'testi.q1_name':     'Dueño de Restaurante',
    'testi.q1_title':    'Daytona Beach, FL',
    'testi.q2':          'El trabajo de SEO local fue un cambio total. Pasamos de la página 3 a la cima de Google Maps. El teléfono no ha parado de sonar.',
    'testi.q2_name':     'Dueño de Negocio Local',
    'testi.q2_title':    'Orlando, FL',
    'testi.q3':          'Lo que distingue a Myrie es la automatización. Nuestro marketing ahora funciona solo: posts sociales, campañas de email, respuestas a reseñas, todo en piloto automático.',
    'testi.q3_name':     'Operador de Franquicia',
    'testi.q3_title':    'Centro de Florida',

    // Mobile sticky CTA
    'mobile_cta.book':   'Agenda una llamada',
    ...
    'about.story_p1':      "O'Neil lidera en la intersección de operaciones y marketing. El día a día de operar un bar y grill en la playa: las horas pico, el inventario, el personal, los especiales diarios, los turistas vs los locales: esa es la lente detrás de cada proyecto en Myrie HQ.",
    'about.story_p2':      "La misión es simple: ayudar a los negocios locales a verse de clase mundial en línea y convertir esa visibilidad en ingresos reales. A través de Myrie HQ, O'Neil apoya a restaurantes, bares y marcas locales en Daytona Beach y Orlando con diseño web moderno, SEO local, creatividad de marca, y el tipo de sistemas de marketing que realmente entregan cada semana.",
    ...
    'about.tl_2025_year':  '2025',
    'about.tl_2025_title': 'App Menu Magic',
    ...
    'bb.cta_live':            'Ver el sitio en vivo',
    'bb.live_eyebrow':        'En Vivo · Ahora en Línea',
    'bb.live_h':              'El sitio web completo de Beach Bucket',
    'bb.live_lede':           'Más allá del diseño de marca, construimos y lanzamos el sitio web completo del restaurante frente al mar — hero con video cinemático, menú editorial con fotografía fotorrealista de platos, tarjetas de regalo interactivas, traducción completa en inglés y español, y direcciones con un solo toque.',

    // ────── Beach Bucket Website (case study) ──────
    'bbw.eyebrow':            'En Vivo · Diseño y Desarrollo Web',
    'bbw.title_a':            'El sitio web de',
    'bbw.title_italic':       'The Beach Bucket.',
    'bbw.sub':                'Un sitio web premium para un restaurante frente al mar en Ormond Beach, Florida — diseñado, construido y lanzado en mayo de 2026. Desplázate, haz clic, ordena, cambia al español — todo está en vivo abajo.',
    'bbw.cta_open':           'Abrir el sitio en vivo',
    'bbw.cta_build':          'Construye el mío así',
    'bbw.iframe_title_laptop':'El sitio web de The Beach Bucket en escritorio',
    'bbw.iframe_title_phone': 'El sitio web de The Beach Bucket en móvil',
    'bbw.mock_caption':       'Vista previa en vivo — interactúa con el sitio directamente dentro del marco del portátil o el teléfono.',
    'bbw.what_eyebrow':       'Lo que entregamos',
    'bbw.what_h':             'Un sitio completo — no una plantilla.',
    'bbw.what_lead':          'Cada sección se construyó a medida desde un sistema de diseño hospitalario: lienzo arena cálida, tipografía Manrope + Fraunces, acentos dorados en precios, hojas punteadas editoriales, sin tarjetas SaaS cuadradas. Las 80 fotos de platos se generaron localmente en Flux Schnell para que cada elemento del menú muestre el plato real.',
    'bbw.tech_vite':          'Framework',
    'bbw.tech_video':         'Hero',
    'bbw.tech_video_v':       'Video cinemático de pantalla completa',
    'bbw.tech_menu':          'Menú',
    'bbw.tech_menu_v':        '80 fotos fotorrealistas generadas con IA',
    'bbw.tech_i18n':          'Idiomas',
    'bbw.tech_perf':          'Rendimiento',
    'bbw.tech_perf_v':        '40 MB total, primera carga en menos de un segundo',
    'bbw.tech_deploy':        'Despliegue',
    'bbw.feat_eyebrow':       'Seis cosas para notar',
    'bbw.feat_h_a':           'Pulido real',
    'bbw.feat_h_italic':      'en cada detalle',
    'bbw.feat1_h':            'Título hero en aqua translúcido',
    'bbw.feat1_p':            'El color de marca se posa sobre el video al 78% de opacidad para que el océano se vea a través de las letras — un solo gesto de diseño que hace que el hero se sienta cinemático en lugar de plano.',
    'bbw.feat2_h':            'Menú editorial de 2 columnas',
    'bbw.feat2_p':            'Nombres en Fraunces serif con líneas punteadas clásicas, precios en dorado, descripciones en cursiva y una miniatura de 72px de cada plato. Haz clic en cualquier nombre o miniatura para abrir el lightbox.',
    'bbw.feat3_h':            'Botón de direcciones pulsante',
    'bbw.feat3_p':            'Sin un mapa embebido feo. Un botón negro con anillos dorados concéntricos pulsando hacia afuera — un toque abre Google Maps. Se ve intencional, se siente vivo.',
    'bbw.feat4_h':            'Tarjetas de regalo con montos clickeables',
    'bbw.feat4_p':            'Una cuadrícula 2×2 (Capricho · Almuerzo · Cita · Celebración) donde cada elección actualiza el CTA de compra en tiempo real. Formulario editorial con borde inferior, sin inputs cuadrados de SaaS.',
    'bbw.feat5_h':            'Inglés y español completos',
    'bbw.feat5_p':            'Cada texto visible pasa por un mapa de traducción y cambia en vivo al elegir idioma. Los elementos del menú se traducen automáticamente vía API para idiomas que aún no localizamos a mano.',
    'bbw.feat6_h':            'Barra de acción móvil',
    'bbw.feat6_p':            'Fija en la parte inferior de cada visita por teléfono: Llamar, Direcciones, Ordenar con un solo toque. Las tres acciones que un visitante hambriento necesita — y nada más.',
    'bbw.final_h_a':          '¿Quieres un sitio así para',
    'bbw.final_h_italic':     'tu negocio?',
    'bbw.final_lead':         'Restaurante, bar, café, lounge, gimnasio, salón, hotel — el mismo sistema de diseño escala. Cuéntame sobre tu negocio y lo construiremos desde cero.',
    'bb.day_monday':          'Lunes',
    ...
    'proj.featured_pill':     'EN VIVO · SITIO WEB',
    'proj.featured_tag':      'DISEÑO WEB · DESARROLLO · BILINGÜE',
    'proj.featured_title':    'El sitio web de The Beach Bucket',
    'proj.featured_blurb':    'Un sitio web premium completo para un restaurante frente al mar en Ormond Beach, Florida. Hero con video cinemático, menú editorial con 80 fotos fotorrealistas de platos, tarjetas de regalo interactivas, inglés y español completo — diseñado, construido y lanzado en mayo de 2026.',
    'proj.r0_title':          'Diseño de Marca Beach Bucket',
    'proj.r0_tag':            'DISEÑO DE MARCA · FOTOGRAFÍA · MENÚS',
    'proj.r0_blurb':          'El cuerpo de trabajo de diseño de marca para The Beach Bucket: tarjetas de especiales diarios, cócteles, fotografía de desayuno y reconstrucciones completas de menús.',
    'proj.metric1_num':       '80',
    'proj.metric1_label':     'Fotos de platos generadas con IA',
    'proj.metric2_num':       '14',
    'proj.metric2_label':     'Secciones personalizadas',
    'proj.metric3_num':       '2',
    'proj.metric3_label':     'Idiomas en vivo (EN + ES)',
    'proj.view_case':         'Verlo en acción →',
    'proj.more_eyebrow':      'MÁS TRABAJO',
    'proj.more_h_a':          'Proyectos',
    'proj.more_h_italic':     'seleccionados',
    'proj.view_project':      'Ver proyecto →',
    'proj.r1_title':          'App Menu Magic',
    ...
    'footer.work_mm':     'Menu Magic en Vivo',
    'footer.co_about':    'Sobre Myrie',
    'footer.co_services': 'El Paquete',
