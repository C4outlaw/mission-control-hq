...
export const DESIGNS_40 = [
  // === BRAND MANTRAS (6) ===
  { key: 'brand-01', title: 'We Never Lose Varsity', design: 'c30-08', image: '/store/catalog-30/c30-08.png', category: 'brand', blurb: 'The mantra. Wear it like you mean it.' },
  { key: 'brand-02', title: 'We Never Lose Wordmark', design: 'c30-09', image: '/store/catalog-30/c30-09.png', category: 'brand', blurb: 'Clean wordmark, bold statement.' },
  { key: 'brand-03', title: 'We Never Lose Hoodie', design: 'c30-10', image: '/store/catalog-30/c30-10.png', category: 'brand', blurb: 'The mantra in heavyweight comfort.' },
  { key: 'brand-04', title: 'More Money Retro', design: 'c30-24', image: '/store/catalog-30/c30-24.png', category: 'brand', blurb: 'The goal, in vintage style.' },
  { key: 'brand-05', title: 'More Money Hoodie', design: 'c30-25', image: '/store/catalog-30/c30-25.png', category: 'brand', blurb: 'Manifest in comfort.' },
  { key: 'brand-06', title: 'More Money Mug', design: 'c30-26', image: '/store/catalog-30/c30-26.png', category: 'brand', blurb: 'Morning motivation in a cup.' },

  // === ORIGINAL FAVORITES (4) ===
  { key: 'orig-01', title: 'Dog Hair Is My Glitter', design: 'c30-05', image: '/store/catalog-30/c30-05.png', category: 'pets', blurb: 'Wear it like you own it.' },
  { key: 'orig-02', title: 'Retired 2026', design: 'c30-22', image: '/store/catalog-30/c30-22.png', category: 'lifestyle', blurb: 'Clocked out for good.' },
  { key: 'orig-03', title: '876 Land We Love', design: 'c30-30', image: '/store/catalog-30/c30-30.png', category: 'culture', blurb: 'Area code pride, island love.' },
  { key: 'orig-04', title: 'Dad Dictionary', design: 'c30-02', image: '/store/catalog-30/c30-02.png', category: 'family', blurb: 'noun: see also hero, legend.' },
];
