...
// The Jamaican work leads, straight under the hero, because that is the brand.
// The premium line follows, then the everyday sellers with their model
// photography, and souvenirs close the page.
const DEPT = {
  island: { id: 'island', label: 'The Island Line', order: 1 },
